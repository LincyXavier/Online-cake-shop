...
<script type="text/javascript">
		...
		{
			if(confirm("Are you sure you want to Continue this category?"))
			{
				window.location.href ='process_disc_cat.php?catid='+catid;
			}
		}
...
<th colspan="6"><b>Action</b></th>
    ...
    <?php
		...
		$sql = "SELECT * from category where available='no'";
...
<tr>						
	              <td><?php echo $row['catid'] ?></td>
								<td><?php echo $row['catname'] ?></td>
								 ...
								 <td>
									<a href="javascript:sureToApprove(<?php echo $row['catid'];?>)" >Continue</a>
