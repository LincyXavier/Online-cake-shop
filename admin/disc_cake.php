...
<script type="text/javascript">
		...
		function sureToApprove(cakeid)
		{
			...
			{
				window.location.href ='process_disc_cake.php?cakeid='+cakeid;
			}
		}
...
<th colspan="6"><b><font color="black">Action</font></b></th>
   ...
   <?php
		...
		$sql="SELECT *,catname FROM cakes,category WHERE category.catid=cakes.catid AND cakeavailability='no'";
			...
			<tr>
			  ...
			  <td><img src="../images/<?php echo $row['cakeimg'] ?>" width="150" height="150"></td>
				...
				<td><?php echo $row['cakedescription'];?></td>
								...
								<td>
									<a href="javascript:sureToApprove(<?php echo $row['cakeid'];?>)" >Continue</a>
